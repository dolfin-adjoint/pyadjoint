...
from .reduced_functional import AbstractReducedFunctional, ReducedFunctional, ParametrisedReducedFunctional
...
class ParametrisedReducedFunctionalNumPy(AbstractReducedFunctional):
    ...
    def __init__(self, functional, controls=None, parameters = None, tape=None):
        if isinstance(functional, AdjFloat):
            functional = ParametrisedReducedFunctional(functional=functional,
                                           controls=controls, parameters=parameters,
                                           tape=tape)
        self.rf = functional
