...
def test_simple():
    ...
    assert Jhat(AdjFloat(2.0)) == e
    p.set_value(e)
    res = Jhat(AdjFloat(2.0))
    assert res != e
    assert res == e*6
    assert Jhat(AdjFloat(2.0)) == e * 6 ** 2
    assert Jhat(AdjFloat(2.0)) == e * 6 ** 3
    assert Jhat(AdjFloat(2.0)) == e * 6 ** 4
    ...
    Jhat.optimize_tape()
    assert Jhat(AdjFloat(2.0)) == e * 6 ** 5
    p.set_value(a)
    assert Jhat(AdjFloat(2.0)) == 2.0 * 6
    assert Jhat.derivative() == 0.5 * 2.0 * 6
    assert Jhat(AdjFloat(5.0)) == 5.0 * 15
