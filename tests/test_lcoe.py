...
def test_lcoe():
    ...
    #discounted_cost = (cost / ((1 + discount_rate) ** np.linspace(0,len(cost)-1.0, len(cost)) ))
    #discounted_energy = (energy / ((1 + discount_rate) ** np.linspace(0,len(energy)-1.0, len(energy)) ))
