...
where :py:data:`J` is an :py:class:`AdjFloat` and :py:data:`m` is a
:py:class:`Control`.
...
* *BFGS*:  The Broydenâ€“Fletcherâ€“Goldfarbâ€“Shanno (BFGS) method.
...
.. code-block:: none
    ...
    40401      6      8      6     0     0   8.869D-09   1.601D-05
    F =   1.6009498922520026E-005
