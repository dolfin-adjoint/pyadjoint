...
p1 = geometry.add_point([0.3,0.5,0], res/2)
p2 = geometry.add_point([0.5,0.56,0], res/2)
p25 = geometry.add_point([0.65, 0.6,0],res/2)
p3 = geometry.add_point([0.7,0.5,0], res/2)
p4 = geometry.add_point([0.5,0.35,0], res/2)
obstacle_top = geometry.add_bspline([p1,p2,p25,p3])
obstacle_bottom = geometry.add_bspline([p3,p4,p1])
loop = geometry.add_line_loop([obstacle_top, obstacle_bottom])
